import { INTERNAL_FORMATS } from 'pixijs/compressed-textures';
import { TYPES } from 'pixijs/core';

var BASIS_FORMATS = /* @__PURE__ */ ((BASIS_FORMATS2) => {
  ...
  return BASIS_FORMATS2;
})(BASIS_FORMATS || {});
const BASIS_FORMAT_TO_INTERNAL_FORMAT = {
  [0 /* cTFETC1 */]: INTERNAL_FORMATS.COMPRESSED_RGB_ETC1_WEBGL,
  [2 /* cTFBC1 */]: INTERNAL_FORMATS.COMPRESSED_RGB_S3TC_DXT1_EXT,
  [3 /* cTFBC3 */]: INTERNAL_FORMATS.COMPRESSED_RGBA_S3TC_DXT5_EXT,
  [8 /* cTFPVRTC1_4_RGB */]: INTERNAL_FORMATS.COMPRESSED_RGB_PVRTC_4BPPV1_IMG,
  [9 /* cTFPVRTC1_4_RGBA */]: INTERNAL_FORMATS.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG,
  [11 /* cTFATC_RGB */]: INTERNAL_FORMATS.COMPRESSED_RGB_ATC_WEBGL,
  [10 /* cTFASTC_4x4 */]: INTERNAL_FORMATS.COMPRESSED_RGBA_ASTC_4x4_KHR
};
const BASIS_FORMAT_TO_TYPE = {
  [13 /* cTFRGBA32 */]: TYPES.UNSIGNED_BYTE,
  [14 /* cTFRGB565 */]: TYPES.UNSIGNED_SHORT_5_6_5,
  [16 /* cTFRGBA4444 */]: TYPES.UNSIGNED_SHORT_4_4_4_4
};
const INTERNAL_FORMAT_TO_BASIS_FORMAT = Object.keys(BASIS_FORMAT_TO_INTERNAL_FORMAT).map((key) => Number(key)).reduce((reverseMap, basisFormat) => {
  reverseMap[BASIS_FORMAT_TO_INTERNAL_FORMAT[basisFormat]] = basisFormat;
  return reverseMap;
}, {});
const BASIS_FORMATS_ALPHA = {
  [3 /* cTFBC3 */]: true,
  [9 /* cTFPVRTC1_4_RGBA */]: true,
  [10 /* cTFASTC_4x4 */]: true
};

export { BASIS_FORMATS, BASIS_FORMATS_ALPHA, BASIS_FORMAT_TO_INTERNAL_FORMAT, BASIS_FORMAT_TO_TYPE, INTERNAL_FORMAT_TO_BASIS_FORMAT };
